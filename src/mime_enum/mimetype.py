...
class MimeType(StrEnum):
    ...
    APPLICATION_OCTET_STREAM = ('application/octet-stream', ('a', 'bin', 'bpk', 'deploy', 'dist', 'distz', 'dmg', 'dms', 'dump', 'elc', 'lha', 'lrf', 'lzh', 'o', 'obj', 'pkg', 'so'))
    ...
    APPLICATION_VND_QUARK_QUARKXPRESS = ('application/vnd.quark.quarkxpress', ('qwd', 'qwt', 'qxb', 'qxd', 'qxl', 'qxt'))
    ...
    APPLICATION_VND_SQLITE3 = ('application/vnd.sqlite3', ('db', 'db-shm', 'db-wal', 'sqlite', 'sqlite-shm', 'sqlite-wal', 'sqlite3'))
    ...
    APPLICATION_VND_VISIO = ('application/vnd.visio', ('vsd', 'vsdx', 'vss', 'vssm', 'vssx', 'vst', 'vstm', 'vstx', 'vsw'))
    ...
    AUDIO_MP4 = ('audio/mp4', ('3g2', '3ga', '3gp', '3gp2', '3gpa', '3gpp', '3gpp2', 'm4a', 'm4b', 'm4p', 'm4r', 'm4v', 'mp4', 'mp4v'))
